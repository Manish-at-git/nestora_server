...
def serialize_association(association) -> AssociationResponse:
    return AssociationResponse(
        ...
        city_id=association.city_id,
        city=association.location_city.name if association.location_city else None,
        state=association.location_city.region.name if association.location_city else None,
        pincode=association.pincode,
        country=association.location_city.region.country.name if association.location_city else None,
        url=association.url,
